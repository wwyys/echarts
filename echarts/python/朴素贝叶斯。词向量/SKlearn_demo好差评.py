...
def FileOpen():
    ...
    for i in range(len(name)):
        path_name="./data/"+name[i]
        processed_textset, allclasstags= loadDataSet(path_name,name[i])
        processed_textset0.extend(processed_textset)
        allclasstags0.extend(allclasstags)
    return processed_textset0,allclasstags0
...
'''
    ...
    print("processed_textset0", processed_textset0)
    print("allclasstags0", allclasstags0)
    predict_result = sklearnNB(processed_textset1, allclasstags1, testset)
    print("predict_result", predict_result)
'''
processed_textset1,allclasstags1=FileOpen()
predict_result=sklearnNB(processed_textset1,allclasstags1,testset)
print("predict_result",predict_result)
